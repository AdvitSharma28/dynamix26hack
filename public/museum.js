const FRAME_RATE = 24;
const ASSET_PATH = "asset/museum_anim/";
const FORWARD_VIDEO = `${ASSET_PATH}dynamix_museum.webm`;
...
const holdHotspots = [
    ...
    [
        { x: 21.2, y: 67.6, detail: "dynamix_1" },
        { x: 81.0, y: 67.6, detail: "dynamix" }
    ],
    [
...
const detailContent = {
    ...
    dynamix_1: {
        ...
        subtitle: "Hindu mythology includes ancient gods, epics, legends, traditions, and sacred stories.",
        body: "Hindu mythology is a vast collection of ancient stories, legends, gods, goddesses, heroes, and sacred traditions from India. It includes powerful deities like Brahma, Vishnu, Shiva, Lakshmi, Saraswati, and Durga. Epic texts such as the Ramayana and Mahabharata explore themes of duty, devotion, courage, morality, creation, and the eternal struggle between good and evil throughout generations and cultures."
    },
    dynamix: {
        hold: 1,
        layout: "dynamix",
        ...
        subtitle: "Greek mythology includes ancient gods, heroic legends, mythical creatures, and timeless stories.",
        body: "Greek mythology is a collection of ancient Greek stories, legends, gods, goddesses, heroes, and mythical creatures. It includes powerful deities like Zeus, Hera, Poseidon, Athena, Apollo, Artemis, and Aphrodite. Famous tales from Greek mythology explore themes of courage, love, fate, heroism, power, and morality through legendary figures such as Hercules, Perseus, Achilles, and Odysseus."
    },
    painting: {
        hold: 2,
        layout: "painting",
        ...
        subtitle: "(1902)",
        body: "the passing of shah jahan is a famous 1902 miniature painting<br>created by indian artist abanindranath tagore. it poignantly depicts the final<br>moments of the imprisoned mughal emperor shah jahan as he lies on his deathbed, reflecting on his faith and<br>the spiritual traditions of islam. devoted to islam throughout his life, shah jahan is remembered as a ruler who<br>valued the quran, prayer, and islamic religious traditions. the scene evokes the spiritual importance of reciting<br>the quran and seeking closeness to allah during the final moments of life, reflecting islamic beliefs about faith,<br>repentance, prayer, and the hereafter. blending traditional mughal miniature aesthetics with british watercolor and japanese wash techniques,<br>the artwork captures a profound sense of bhava (deep sentiment and melancholy), while connecting shah jahan's final moments with the spiritual traditions of islam."
    },
    ashoka: {
        hold: 3,
        layout: "ashoka",
        ...
        title: "ashoka pillar",
        subtitle: "",
        body: "A timeless symbol surrounded by legends of Emperor Ashoka and the Mauryan dynasty.<br><br>In Indian folklore and Buddhist traditions, Ashoka is remembered as a powerful ruler whose life transformed from conquest to a path of dhamma, compassion, and peace. Stories tell of his deep connection with Buddhism, his support for monks and sacred places, and his efforts to spread the teachings of the Buddha across distant lands. Traditional accounts also connect Ashoka with the legendary Ashoka tree, a symbol of love, fertility, and auspiciousness in Indian culture. The pillars he commissioned became lasting symbols of his rule, carrying messages of moral living, kindness, justice, and respect for all living beings."
    },
    priest: {
        hold: 3,
        layout: "priest",
        ...
        body: "The Priest-King of Mohenjo-daro is surrounded by mystery, imagination, and modern folklore about the ancient Indus Valley Civilization. Indus Valley folklore often portrays the people of this ancient civilization as deeply connected to nature, rivers, sacred animals, fertility, and spiritual rituals. Although the sculpture's true identity remains unknown, folklore has inspired stories about wise priest-kings, spiritual leaders, and rulers who guided their communities through sacred traditions.<br><br>In popular folklore, the calm expression and richly patterned robe are sometimes imagined as symbols of religious authority and ancient wisdom. Folklore also connects the mysterious cities of the Indus Valley with forgotten ceremonies, sacred spaces, and legends passed down through generations. While this folklore creates fascinating stories around the Priest-King, archaeology cannot confirm these legends or prove that the figure was actually a priest or king. Today, the sculpture remains an enduring symbol of Indus Valley folklore, ancient mystery, and the rich cultural imagination surrounding one of the world's earliest civilizations."
    }
};
