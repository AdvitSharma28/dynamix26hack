...
const challengeImages = [
    "asset/monopoly/board assets/Challenge questions/challenge question-1.png",
    "asset/monopoly/board assets/Challenge questions/challenge question-2.png",
    "asset/monopoly/board assets/Challenge questions/challenge question-3.png",
    "asset/monopoly/board assets/Challenge questions/challenge question-4.png",
    "asset/monopoly/board assets/Challenge questions/challenge question-5.png",
    "asset/monopoly/board assets/Challenge questions/challenge question-6.png",
    "asset/monopoly/board assets/Challenge questions/challenge question.png",
];
...
function initBoard() {
    ...
    players.forEach(p => {
        ...
        avatar.src = p.avatar;
        avatar.alt = `${p.name} game character`;
...
function updatePlayerNameDisplays() {
    players.forEach((player) => {
        ...
        if (avatar) {
            avatar.alt = `${player.name} game character`;
        }
    });
}
